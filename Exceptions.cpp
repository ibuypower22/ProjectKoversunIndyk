...
{
    switch (error) {
    case 1: MessageBox::Show("У цьому профілі немає нотаток.");  break;
    case 2: MessageBox::Show("Введіть нотатку."); break;
    case 3: MessageBox::Show("Ви не ввели нотатку, яку потрібно знайти."); break;
    case 4: MessageBox::Show("Ви ввели нотатку, затримка якої перевищує максимально допустиме значення (999)."); break;
