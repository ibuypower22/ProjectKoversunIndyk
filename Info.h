...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		MessageBox::Show("В этом профиле нет отправленных сообщений");
	}
	else {
...
private: System::Void button2_MouseLeave(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (!File::Exists(potok))
		{
			...
			if (searchtext == "") { MessageBox::Show("Вы не ввели искомое сообщение"); }
			else 
		{
			StreamReader^ sr = gcnew StreamReader(potok);
			...
			if (flag==false) MessageBox::Show("Сообщение не найдено :(");  else
			MessageBox::Show("Сообщение найдено: " + decrypt(tempsentence) + ", его задержка: " + tempping+", всего таких сообщений: "+k);
		}
}
